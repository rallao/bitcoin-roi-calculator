...
function returnOverInvestment(){
    ...
    $("#text-results").append(`<p class="background">Your ${assetSelected } would be worth <strong class="background">$${winLoss}USD</strong> now, thats <strong class=-"background">${roi+"%"}</strong> over your $${amountSelected} initial investment </p> `);
};
